...
public class BlockManager
{
    ...
    static class AcquireBlock extends BaseThread
    {
        ...
        public void run()
        {
            ...
            s1.P();
            if(!flag) {
                System.out.println("=============All Threads Finished PHASE1===========");
                flag = true;
                s2.V();
            }
            s1.V();
            ...
            /**
             * main thread finished  print out the counter's value
             */
            System.out.println("AccessCounter value = "+soStack.getAccessCounter());
            s2.V();
        }
    } // class AcquireBlock
