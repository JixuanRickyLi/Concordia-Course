...
public class BasicCrawler extends WebCrawler {
    ...
    public static String url_record = "./data/visited.txt";
    ...
    public boolean shouldVisit(Page referringPage, WebURL url) {
        ...
        return href.startsWith("https://www.concordia.ca/");
    }
...
//
        if (page.getParseData() instanceof HtmlParseData) {
            ...
            try{
                BufferedWriter out = new BufferedWriter(new FileWriter(url_record,true));
                out.write(counter + ": "+ url + "\n");
                out.close();
            } catch (IOException e) {
                e.printStackTrace();
            }
            ...
            String fileName = "./data/" + counter++ + ".html";
            try{
                BufferedWriter out = new BufferedWriter(new FileWriter(fileName));
                out.write("<url>");
                out.write(url);
                out.write("</url>");
                out.write("<MainText>" + html + "</MainText>");
                out.close();
            } catch (IOException e) {
                e.printStackTrace();
            }
