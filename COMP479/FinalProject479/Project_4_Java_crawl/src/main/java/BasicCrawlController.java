...
//        config.setHaltOnError(true);
        ...
        controller.addSeed("https://www.concordia.ca/");
        ...
        final AtomicInteger numSeenImages = new AtomicInteger();

        // The factory which creates instances of crawlers.
        CrawlController.WebCrawlerFactory<BasicCrawler> factory = new CrawlController.WebCrawlerFactory<BasicCrawler>() {
            public BasicCrawler newInstance() throws Exception {
                return new BasicCrawler(numSeenImages);
            }
        };
